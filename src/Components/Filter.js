...
function Filter() {
    ...
    return (
        <div className="filter" >
         <div>
                    <input type="radio" name="filter" onChange={(e)=>handleisDone(e.target.checked)} ></input>
                    <label style={{color:'white'}} > Completed</label>
                    </div>
                    <div>
                    <input type="radio" name="filter" onChange={(e)=>handleNotDone(e.target.checked)} ></input>
                    <label style={{color:'white'}} > Not completed</label>
                    </div>
        </div>
